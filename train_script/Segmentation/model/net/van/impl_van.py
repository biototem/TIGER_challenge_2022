...
class VAN(nn.Module):
    ...
    def init_weights(self, pretrained=None):
        ...
        # weights -->> ['epoch', 'arch', 'state_dict', 'optimizer', 'version', 'args', 'amp_scaler', 'metric']
        # print(weights['state_dict'].keys())
        # 权重文件来自分类网络，使用的是分类头，这在分割网络中并不存在
        weights['state_dict'].pop('head.weight')
        weights['state_dict'].pop('head.bias')
